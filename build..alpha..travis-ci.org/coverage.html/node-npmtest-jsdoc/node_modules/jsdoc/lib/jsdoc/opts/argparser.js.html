...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/opts/argparser.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/opts/argparser.js</span></h1>
    <h2>
        
        Statements: <span class="metric">71.67% <small>(86 / 120)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">71.67% <small>(86 / 120)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/opts/</a> &#187; argparser.js</div>
</div>
<div class="body">
...
&nbsp;
ArgParser.prototype._getOptionByShortName = <span class="fstat-no" title="function not covered" >function(name) {</span>
<span class="cstat-no" title="statement not covered" >    if (hasOwnProp.call(this._shortNameIndex, name)) {</span>
<span class="cstat-no" title="statement not covered" >        return this._options[this._shortNameIndex[name]];</span>
    }
<span class="cstat-no" title="statement not covered" >    return null;</span>
};
&nbsp;
ArgParser.prototype._getOptionByLongName = <span class="fstat-no" title="function not covered" >function(name) {</span>
<span class="cstat-no" title="statement not covered" >    if (hasOwnProp.call(this._longNameIndex, name)) {</span>
<span class="cstat-no" title="statement not covered" >        return this._options[this._longNameIndex[name]];</span>
    }
<span class="cstat-no" title="statement not covered" >    return null;</span>
};
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (longName) {
...
&nbsp;
        if (option.shortName) {
            name += '-' + option.shortName + (option.longName ? ', ' : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>;
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (option.longName) {
...
ArgParser.prototype.parse = function(args, defaults) {
    var result = defaults &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >_.defaults({}, defaults) </span>|| {};
&nbsp;
    result._ = [];
...
<span class="cstat-no" title="statement not covered" >        if (arg.charAt(0) === '-') {</span>
            // like --template
<span class="cstat-no" title="statement not covered" >            if (arg.charAt(1) === '-') {</span>
<span class="cstat-no" title="statement not covered" >                name = longName = arg.slice(2);</span>
<span class="cstat-no" title="statement not covered" >                option = this._getOptionByLongName(longName);</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                name = shortName = arg.slice(1);</span>
<span class="cstat-no" title="statement not covered" >                option = this._getOptionByShortName(shortName);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (option === null) {</span>
<span class="cstat-no" title="statement not covered" >                throw new Error( util.format('Unknown command-line option "%s".', name) );</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (option.hasValue) {</span>
<span class="cstat-no" title="statement not covered" >                value = next;</span>
<span class="cstat-no" title="statement not covered" >                i++;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (value === null || value.charAt(0) === '-') {</span>
<span class="cstat-no" title="statement not covered" >                    throw new Error( util.format('The command-line option "%s" requires a value.', name) );</span>
                }
            }
            else {
...
<span class="cstat-no" title="statement not covered" >            if (option.ignore) {</span>
<span class="cstat-no" title="statement not covered" >                continue;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (option.longName &amp;&amp; shortName) {</span>
<span class="cstat-no" title="statement not covered" >                name = option.longName;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (typeof option.coercer === 'function') {</span>
<span class="cstat-no" title="statement not covered" >                value = option.coercer(value);</span>
            }
&nbsp;
            // Allow for multiple options of the same type to be present
<span class="cstat-no" title="statement not covered" >            if (option.canHaveMultiple &amp;&amp; hasOwnProp.call(result, name)) {</span>
<span class="cstat-no" title="statement not covered" >                var val = result[name];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (val instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >                    val.push(value);</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    result[name] = [val, value];</span>
                }
            }
            else {
...
<span class="cstat-no" title="statement not covered" >            result._.push(arg);</span>
        }
    }
&nbsp;
    return result;
