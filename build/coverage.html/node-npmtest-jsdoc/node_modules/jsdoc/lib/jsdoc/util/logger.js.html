...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/util/logger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/util/logger.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/util/</a> &#187; logger.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function addPrefix(args, prefix) {</span>
<span class="cstat-no" title="statement not covered" >    var updatedArgs;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (prefix &amp;&amp; typeof args[0] === 'string') {</span>
<span class="cstat-no" title="statement not covered" >        updatedArgs = args.slice(0);</span>
<span class="cstat-no" title="statement not covered" >        updatedArgs[0] = prefix + updatedArgs[0];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return updatedArgs || args;</span>
}
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (logLevel &gt;= level) {
<span class="cstat-no" title="statement not covered" >            loggerArgs = addPrefix(args, prefix);</span>
<span class="cstat-no" title="statement not covered" >            func.apply(null, loggerArgs);</span>
        }
&nbsp;
...
<span class="fstat-no" title="function not covered" >function printToStdout() {</span>
<span class="cstat-no" title="statement not covered" >    var args = Array.prototype.slice.call(arguments, 0);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    process.stdout.write( util.format.apply(util, args) );</span>
}
&nbsp;
/**
 ...
 */
logger.setLevel = <span class="fstat-no" title="function not covered" >function setLevel(level) {</span>
<span class="cstat-no" title="statement not covered" >    logLevel = (level !== undefined) ? level : DEFAULT_LEVEL;</span>
};
&nbsp;
/**
 ...
 */
logger.getLevel = <span class="fstat-no" title="function not covered" >function getLevel() {</span>
<span class="cstat-no" title="statement not covered" >    return logLevel;</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
