...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/</a> &#187; config.js</div>
</div>
<div class="body">
...
function Config(json) {
    json = JSON.parse( (json || <span class="branch-1 cbranch-no" title="branch not covered" >'{}')</span> );
