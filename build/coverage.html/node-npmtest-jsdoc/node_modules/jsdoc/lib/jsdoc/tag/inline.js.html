...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/tag/inline.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/tag/inline.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsdoc/node_modules/jsdoc/lib/jsdoc/tag/</a> &#187; inline.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function regExpFactory(tagName, prefix, suffix) {</span>
<span class="cstat-no" title="statement not covered" >    tagName = tagName || '\\S+';</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return new RegExp(prefix + '\\{@' + tagName + '\\s+((?:.|\n)+?)\\}' + suffix, 'i');</span>
}
&nbsp;
/**
 ...
 * cases.
 */
exports.isInlineTag = <span class="fstat-no" title="function not covered" >function(string, tagName) {</span>
<span class="cstat-no" title="statement not covered" >    return regExpFactory(tagName, '^', '$').test(string);</span>
};
&nbsp;
/**
 ...
 */
exports.replaceInlineTags = <span class="fstat-no" title="function not covered" >function(string, replacers) {</span>
<span class="cstat-no" title="statement not covered" >    var tagInfo = [];</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function replaceMatch(replacer, tag, match, text) {</span>
<span class="cstat-no" title="statement not covered" >        var matchedTag = {</span>
            completeTag: match,
            tag: tag,
            text: text
        };
<span class="cstat-no" title="statement not covered" >        tagInfo.push(matchedTag);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return replacer(string, matchedTag);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    string = string || '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    Object.keys(replacers).forEach(<span class="fstat-no" title="function not covered" >function(replacer) {</span></span>
<span class="cstat-no" title="statement not covered" >        var tagRegExp = regExpFactory(replacer);</span>
<span class="cstat-no" title="statement not covered" >        var matches;</span>
<span class="cstat-no" title="statement not covered" >        var previousString;</span>
&nbsp;
        // call the replacer once for each match
<span class="cstat-no" title="statement not covered" >        do {</span>
<span class="cstat-no" title="statement not covered" >            matches = tagRegExp.exec(string);</span>
<span class="cstat-no" title="statement not covered" >            if (matches) {</span>
<span class="cstat-no" title="statement not covered" >                previousString = string;</span>
<span class="cstat-no" title="statement not covered" >                string = replaceMatch(replacers[replacer], replacer, matches[0], matches[1]);</span>
            }
 ...
 * about the inline tags that were found.
 */
exports.replaceInlineTag = <span class="fstat-no" title="function not covered" >function(string, tag, replacer) {</span>
<span class="cstat-no" title="statement not covered" >    var replacers = {};</span>
<span class="cstat-no" title="statement not covered" >    replacers[tag] = replacer;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return exports.replaceInlineTags(string, replacers);</span>
};
&nbsp;
/**
 ...
 * about the inline tags that were found.
 */
exports.extractInlineTag = <span class="fstat-no" title="function not covered" >function(string, tag) {</span>
<span class="cstat-no" title="statement not covered" >    return exports.replaceInlineTag(string, tag, <span class="fstat-no" title="function not covered" >function(str, tagInfo) {</span></span>
<span class="cstat-no" title="statement not covered" >        return str.replace(tagInfo.completeTag, '');</span>
    });
};
&nbsp;
&nbsp;</pre></td></tr>
