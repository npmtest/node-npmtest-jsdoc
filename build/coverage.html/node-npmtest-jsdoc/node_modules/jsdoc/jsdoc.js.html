...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jsdoc/node_modules/jsdoc/jsdoc.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jsdoc/node_modules/jsdoc/jsdoc.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jsdoc/node_modules/jsdoc/</a> &#187; jsdoc.js</div>
</div>
<div class="body">
...
&nbsp;
    var path;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (args[0] &amp;&amp; typeof args[0] === 'object') {
...
&nbsp;
    cli.setVersionInfo()
        .loadConfig();
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!env.opts.test) {
        cli.configureLogger();
    }
&nbsp;
    cli.logStart();
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (env.opts.debug) {
         ...
         */
<span class="cstat-no" title="statement not covered" >        global.dump = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >            console.log(require('./lib/jsdoc/util/dumper').dump(arguments));</span>
        };
    }
&nbsp;
    cli.runCommand(cb);
